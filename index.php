...
<head>
  ...
  <title> Advertising Company </title>
    ...
    <div class="container">
      ...
      <nav class="navbar container" data-navbar>
        <ul class="navbar-list">
          ...
          <li>
            <a href="#table" class="navbar-link" data-nav-link>Table</a>
          </li>
          <li>
            <a href="#table" class="navbar-link" data-nav-link>Admin</a>
          </li>
          <li>
      ...
      <section class="section hero" id="home" aria-label="hero">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle"> DS Advertising Agency</p>

            <h1 class="h1 hero-title">We are available for Advertising</h1>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Digital Advertising</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Ad Research</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Email Advertising</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Advertising & Reporting</a>
                </h3>
            ...
            <li>
              <div class="project-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-subtitle">Digital Advertising</p>
            ...
            <li>
              <div class="project-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-subtitle">Email Advertising</p>
            ...
            <li>
              <div class="project-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-subtitle">Advertising & Reporting</p>
      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <div class="about-banner img-holder" style="--width: 720; --height: 960;">
            <video autoplay loop muted src="./assets/images/Nitro Pepsi.mp4" width="720" height="960" loading="lazy" alt="about banner"
              class="img-cover">
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder" style="--width: 860; --height: 646;">
                  <img src="./assets/images/pepsi-thats-what-i-like-logo.jpg" width="860" height="646" loading="lazy"
                    alt="How to Become a Successful Entry Level" class="img-cover">
                </figure>
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title">How to Become a Successful Entry Level Pepsi </a>
                  </h3>
        ...
        <div class="container">
          ...
          <form action="" class="contact-form">
            ...
            <div class="input-wrapper">
              <input type="text" name="ename" aria-label="name" placeholder="Your name*" required class="input-field">
            ...
            <li class="contact-item">
              <div class="contact-card">
                ...
                <div class="card-content">
                  ...
                  <a href="mailto:hello@luaz.com" class="card-link">dhaneshwar@gmail.com</a>
                  <a href="mailto:info@luaz.com" class="card-link">info@gmail.com</a>
              ...
              <div class="contact-card">
                ...
                <div class="card-content">
                  ...
                  <address class="card-address">
                    Sahupara, Shrinagar, Raipur, Gudhiyari, Chhattisgarh 492002
                  </address>
            ...
            <li class="contact-item">
              <div class="contact-card">
                ...
                <div class="card-content">
                  ...
                  <a href="tel:9340505139" class="card-link">+91 9340505139</a>
                  <a href="tel:9340505139" class="card-link">+91 9340505139</a>
